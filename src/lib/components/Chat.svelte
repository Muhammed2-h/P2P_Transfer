    ...
    <div class="chat-window glass-panel fade-in">
      ...
      <div class="messages" bind:this={chatContainer}>
        ...
        {#each $transfer.messages as msg}
          <div id="msg-{msg.id}" class="msg-row" class:me={msg.sender === "me"}>
            <div class="bubble-container">
                ...
                {#if replied}
                  ...
                  >
                    ...
                    <p class="reply-text truncate">
                      {replied.image ? "📷 Image" : replied.text}
                    </p>
                  </div>
                {/if}
              {/if}
              ...
              <div class="bubble group">
                ...
                {#if msg.video}
                  ...
                  <video src={msg.video} controls class="chat-image"></video>
                {/if}
                {#if msg.text}
                  <p>
                    {msg.text}
                    {#if msg.edited}<span class="edited-tag">(edited)</span
                      >{/if}
                  </p>
                {/if}
      ...
      <div class="input-area relative">
        ...
        {#if showAttachMenu}
          <div class="attach-menu glass-panel fade-up">
            ...
            <button class="menu-item" on:click={() => openCamera("photo")}>
              <div class="icon-wrap color-2">
                <Camera size={14} />
              </div>
              <span>Camera</span>
            </button>
            <button class="menu-item" on:click={() => openCamera("video")}>
          ...
          <div
            ...
            on:keydown={(e) => e.key === "Escape" && (showAttachMenu = false)}
          ></div>
        {/if}
